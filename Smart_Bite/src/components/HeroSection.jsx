...
const HeroSection = () => {
  return (
    <header className="relative bg-cover bg-center h-screen text-white flex items-center justify-center"
      ...
      <div className="relative z-10 text-center backdrop-blur-sm bg-white/10 p-8 rounded-xl">
